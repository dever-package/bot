...
type Asset struct {
	...
	CollectionID uint64     `dorm:"type:bigint;not null;default:0;comment:所属集合"`
...
type AssetIndex struct {
	...
	TeamCollection        struct{} `index:"team_id,collection_id,status,sort,id"`
