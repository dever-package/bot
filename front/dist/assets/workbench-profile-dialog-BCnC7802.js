import { c as I, j as a, a as o, F as ue } from "./createLucideIcon-CEtb6KSk.js";
import { r as de, g as fe, e as me, a as he, u as d, b as G, D as pe, w as ge, x as be, y as ve, z as we, A as ye, B as A, I as Y } from "./runtime-entry-CIrzyMsA.js";
import { L as $ } from "./loader-circle-QnfinZ3F.js";
import { U as Ne } from "./user-round-uRCY5ob-.js";
import { E as Pe } from "./eye-off-nE66yPeQ.js";
import { E as Ce } from "./eye-EJzwoxVH.js";
import { T as Ae } from "./trash-2-EsqTj1ob.js";
import { t as H } from "./index-DqjOvQjw.js";
import { W as ke } from "./home-shell-DNmuRlvV.js";
...
function Ze({
  ...
  const n = me((t) => t.auth), f = he(null), [l, g] = d("profile"), [u, b] = d(
    () => K(n.user)
  ), [w, k] = d(u.name), [v, R] = d(null), [re, U] = d(""), [x, _] = d(!1), [S, j] = d(""), [y, z] = d(""), [W, M] = d(""), [te, T] = d(!1), [N, V] = d(!1), [p, P] = d(!1), [B, s] = d("");
  G(() => {
    if (!e)
      return;
    let t = !0;
  ...
  function oe() {
    g("profile"), R(null), _(!1), j(""), z(""), M(""), T(!1), s("");
  }
  function O(t) {
    p || (g(t), s(""));
  }
  ...
  async function ce() {
    ...
    P(!0), s("");
    try {
      const m = v ? await Me(u.id, v) : x ? 0 : u.avatarFileID, h = await ze({
        name: t,
        avatarFileID: m
      });
  ...
  async function le() {
    ...
    P(!0), s("");
    try {
      await We({ currentPassword: S, newPassword: y }), H.success("密码已修改，请重新登录"), c();
    } catch (t) {
      s(C(t, "修改密码失败"));
    } finally {
      P(!1);
