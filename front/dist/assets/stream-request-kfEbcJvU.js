import { j as s, a as g, F as ht } from "./createLucideIcon-CEtb6KSk.js";
import { g as Ye, c as G, u as m, a as _, b as B, d as Y } from "./runtime-entry-CIrzyMsA.js";
import { u as Zt } from "./react-DlzYln-Z.js";
import { L as ke } from "./loader-circle-QnfinZ3F.js";
import { S as er } from "./send-B43JK-vZ.js";
import { S as tr } from "./square-BLHlcv3k.js";
import { m as rr } from "./content-view-DmJsJzkL.js";
import { m as nr } from "./button-DxSljrwo.js";
import { m as sr } from "./searchable-option-picker-BDKon8GD.js";
import { m as xt } from "./request-BZGgNvyG.js";
import { m as kt } from "./runtime-stream-runner-CetjHKwi.js";
import { m as ir, a as Oe } from "./stream-BdPqUizK.js";
import { m as or } from "./store-EYzASISC.js";
import { A as _t, c as ar } from "./clipboard-BxQw6DpJ.js";
import { m as oe } from "./stream-timing-02CF4VzI.js";
import { A as lr, u as ur } from "./asset-reference-provider-qeDIBhpP.js";
import { j as cr, k as At, u as dr, n as mr } from "./upload-asset-api-DAbIOMVJ.js";
import { H as Ot } from "./history-DOFgCRvO.js";
import { R as fr } from "./refresh-cw-BtajSIJx.js";
import { X as pr } from "./x-D8YQA7_X.js";
  ...
  const fe = d.selectedItem, Ve = b ? et : U?.status || fe?.status || "pending", ft = b ? Wt : Tt(Ve), pt = b ? z.finalOutput : U?.output || null, rt = {
    ...
    /* @__PURE__ */ g(
      $t,
      {
        ...
        children: [
          R ? /* @__PURE__ */ s(ke, { className: "mr-2 size-4 animate-spin" }) : /* @__PURE__ */ s(er, { className: "mr-2 size-4" }),
          R ? "生成中..." : "生成"
        ]
      }
    )
...
function It({
  ...
  return /* @__PURE__ */ g(
    $t,
    {
      ...
      children: [
        t ? /* @__PURE__ */ s(ke, { className: "mr-2 size-3.5 animate-spin" }) : /* @__PURE__ */ s(tr, { className: "mr-2 size-3.5" }),
        e ? "停止" : "不可停止"
      ]
    }
  );
