import { c as $ } from "./createLucideIcon-CEtb6KSk.js";
import { a as g, m as M } from "./stream-BdPqUizK.js";
import { m as E } from "./request-BZGgNvyG.js";
import { F as K } from "./runtime-entry-CIrzyMsA.js";
const J = [["path", { d: "m18 15-6-6-6 6", key: "153udz" }]], Ut = $("chevron-up", J);
const G = [
...
function it(t) {
  ...
  if (!e)
    return;
  const n = Array.isArray(t.blocks), r = n ? t.blocks.map(P).filter((s) => !!s).sort(F) : [], i = R(t.status);
  return {
    id: e,
    hydrated: n,
...
function z(t, e) {
  ...
  return Array.from(n.values()).sort(F);
}
function ut(t, e) {
