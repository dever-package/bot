import { R as a } from "./runtime-entry-ClkZDmNs.js";
import { R as Ut } from "./site-config-DrnclGFw.js";
function Xt(r) {
...
const he = (r) => {
  ...
  return /* @__PURE__ */ a.createElement("li", {
    ...
    onPointerUp: () => {
      ...
      if (K || !G) return;
      J.current = null;
      const k = Number(((n = P.current) == null ? void 0 : n.style.getPropertyValue("--swipe-amount-x").replace("px", "")) || 0), ut = Number(((h = P.current) == null ? void 0 : h.style.getPropertyValue("--swipe-amount-y").replace("px", "")) || 0), y = (/* @__PURE__ */ new Date()).getTime() - ((w = Tt.current) == null ? void 0 : w.getTime()), D = $ === "x" ? k : ut, ft = Math.abs(D) / y;
  ...
  }, (Dt = v?.close) != null ? Dt : te) : null, (N || t.icon || t.promise) && t.icon !== null && (v?.[N] !== null || t.icon) ? /* @__PURE__ */ a.createElement("div", {
    "data-icon": "",
