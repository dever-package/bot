import { c as Y, j as o, a as u } from "./createLucideIcon-fWv1XcFy.js";
import { x as Z, u as Q, a as ee, b as m, e as te, d as oe, y as re, c as p, r as z, n as $, I as A, z as ne, A as ae } from "./runtime-entry-ClkZDmNs.js";
import { L as W } from "./vanilla-BSPxkY5-.js";
import { E as ie } from "./eye-off-BhvtJvtS.js";
import { E as se } from "./eye-D9RIhpvx.js";
import { M as le, h as ce, B as de, a as ue } from "./body-filing-ClK58x0I.js";
import { X as ge } from "./in-flight-request-CXY2yBH9.js";
import { t as w } from "./index-Cf7idtTi.js";
import { u as me, a as he, m as x, o as fe, p as we } from "./site-config-DrnclGFw.js";
import { u as pe, B as be, d as C, a as ke, b as H, c as O } from "./site-brand-E6f0Ffb2.js";
const ye = [
...
function Xe() {
  ...
  pe(e.site.appearance, i);
  const [s, y] = m("login"), [U, G] = m(""), [B, J] = m(""), [P, N] = m(""), [R, g] = m(""), [L, M] = m(!1), [F, b] = m(
    null
  ), [k, V] = m(!1), [E, I] = m(!1), S = te(!1), h = L || F !== null, _ = e.site.appearance.loginTemplate === "minimal", v = oe(
    async (r, d) => {
      if (!r?.token)
        throw new Error("登录返回缺少 token");
      re(), c.setUser(r.user), c.setAccessToken(r.token), w.success(
  ...
  return !t || !n ? /* @__PURE__ */ o(
    ...
    "main",
    {
      ...
      "data-page-background": we(e.site.appearance, "login") ? "custom" : void 0,
            ...
            "section",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ u("section", { className: "bot-work-login-form-panel", children: [
                  ...
                  /* @__PURE__ */ u("form", { className: "bot-work-login-form", onSubmit: q, children: [
                  ...
                  e.site.registerEnabled ? /* @__PURE__ */ u("p", { className: "bot-work-login-mode-switch", children: [
                    ...
                    /* @__PURE__ */ o("button", { type: "button", disabled: h, onClick: X, children: s === "login" ? "注册" : "登录" })
                  ] }) : null,
