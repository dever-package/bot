import { c as Ge, j as i, a as p, F as Wt } from "./createLucideIcon-fWv1XcFy.js";
import { g as Yt, b as I, e as Ot, i as Te, c as Xe, d as K } from "./runtime-entry-ClkZDmNs.js";
import { L as Ee } from "./vanilla-BSPxkY5-.js";
import { C as Ur } from "./check-B_RB4H2g.js";
import { N as mn } from "./network-DcjXzes3.js";
import { P as gn } from "./_commonjsHelpers-BNFp87fY.js";
import { S as Wr } from "./save-kV_dHGFf.js";
import { W as dt, U as _n } from "./workflow-DCWxX26l.js";
import { X as ct } from "./in-flight-request-CXY2yBH9.js";
import { t as $ } from "./index-Cf7idtTi.js";
import { m as Mn } from "./request-m1WJL1Tm.js";
import { m as ht } from "./utils-CHRiz5MX.js";
import { m as Xt } from "./button-D8VCR9tT.js";
import { m as Yr } from "./confirm-dialog-vkWX0nGl.js";
import { m as Xr } from "./task-popover-nchDdidF.js";
import { n as Vr, a as Zr, w as Jr, m as Qr, r as eo, R as to, u as no, P as lt, b as ro, i as oo, C as io, H as pn, c as so, g as ao, B as $t, E as co } from "./normalize-BCEPlWl_.js";
import { C as lo } from "./circle-alert-B2uOyl1_.js";
import { S as uo } from "./sparkles-hCbN2Dw6.js";
import { B as fo } from "./book-open-DC0acw4D.js";
import { B as mo } from "./bot-JFFKszUF.js";
import { F as go } from "./file-text-GWInsYzS.js";
import { G as _o } from "./git-branch-fr-ihES2.js";
import { T as jn } from "./trash-2-C2PWG3er.js";
import { Z as po } from "./zap-CEP3W7uy.js";
import Gn from "./interaction-panel-Cqu34wUb.js";
import { m as J } from "./dialog-Bzy9HxZl.js";
import { m as Ze } from "./select-xWfZFu71.js";
import { m as ye } from "./stream-timing-xZXCx8RF.js";
import { m as bo } from "./reference-B-56qkaz.js";
import { m as qn } from "./textarea-ICqTPa3p.js";
import { m as yo } from "./content-view-BXwDWBA5.js";
import { m as ho } from "./input-CpVa-RSd.js";
import { m as ko } from "./searchable-option-picker-B2bxMM1v.js";
const wo = [
...
const To = [
  ...
  display: "block",
  flex: "0 0 auto"
}, Io = "draft", ft = "published", Bt = "editing", ce = "running", Se = "waiting", Ne = "success", wt = "fail", Wn = "canceled", Vt = "pending", Po = 15e3, xe = "_client_started_at", Ft = "_stream_last_id", Oo = [
  {
    path: "form.name",
    name: "名称",
    type: "form-input"
...
function zo(e) {
  return Array.from(
    new Set(
      Qt(e).map((n) => Number(n.cate_id || 0)).filter(Boolean)
    )
  ).map((n) => ({
    id: n,
    value: `分类${n}`
...
function Jt(e) {
  ...
  return Un.some((n) => n.id === t) ? t : "exists";
}
function Yn(e, t, n) {
  const r = t.find((o) => o.node_key === e.from_key);
  return r ? r.type === "condition" ? kn(n, ["passed", "failed"]) : r.type === "human_approval" ? kn(n, ["approved", "rejected"]) : [] : [];
}
function kn(e, t) {
...
function Fo(e) {
  return {
    ...
    agents: Array.isArray(e?.agents) ? Qt(e.agents) : [],
    ...
    role_types: Array.isArray(e?.role_types) ? e.role_types : Kn,
    powers: Array.isArray(e?.powers) ? e.powers : [],
    power_kinds: Array.isArray(e?.power_kinds) ? e.power_kinds : [],
    node_types: Array.isArray(e?.node_types) ? e.node_types : kt,
    edge_conditions: Array.isArray(e?.edge_conditions) ? e.edge_conditions : Hn
  };
}
function Lo(e) {
  const t = e && typeof e == "object" ? { ...e } : {};
  return t.publish_status = en(
    t.publish_status
...
function en(e) {
  ...
  return t === ft || t === "已发布" || t === "发布" ? ft : t === Bt || t === "编辑草稿" || t === "editing_draft" ? Bt : Io;
}
function Zn(e) {
  return !!e?.readonly || en(e?.publish_status) === ft;
}
function Go(e) {
  return e === ft ? "已发布" : e === Bt ? "编辑草稿" : "草稿";
}
function wn(e, t, n) {
...
function qo(e, t) {
  ...
  return n === "role" ? "团队角色" : n === "team" ? "团队工作流" : t.find((r) => r.id === n)?.value || kt.find((r) => r.id === n)?.value || n;
}
function Ko(e) {
...
function bi(e, t) {
  const n = t?.output;
  return t?.type === "result" && yi(n) ? rr(e, n) : A(n) ? hi(e, n) : e;
}
function rr(e, t) {
  const n = Qr(e, t);
  return {
...
function hi(e, t) {
  const n = tn(e), r = String(t.scope || "");
  return (r === "run" || ki(t.event)) && (n.run = wi(n.run, t)), r === "flow" && (n.flow_runs = Dn(
    n.flow_runs,
    xi(t),
    ["id", "flow_id", "flow_key"]
  )), r === "node" && (n.node_runs = Dn(
    n.node_runs,
    vi(t),
    ["id", "node_key", "node_id"]
...
function wi(e, t) {
  const n = { ...e || {} };
  return be(n, "id", t.run_id), be(n, "team_id", t.team_id), be(n, "release_id", t.release_id), be(n, "status", nn(t, t.status || t.run_status)), be(n, "input", t.input), be(n, "output", t.output), be(n, "error", t.error), be(n, "started_at", t.started_at), be(n, "finished_at", t.finished_at), n;
}
function xi(e) {
  return or({
    id: e.flow_run_id,
...
function vi(e) {
  return or({
    ...
    status: nn(e, e.status || e.node_status),
    input: e.input,
    output: e.output,
...
function Si(e) {
  if (String(e?.status || "") !== Vt || !e?.id)
    return null;
  const t = de(e?.content), n = cr(
    t.interaction,
    e?.title,
    e?.id
  );
...
function Ei(e, t, n, r, o = {}) {
  const s = {}, a = sn(E(e?.agent_runs)), c = /* @__PURE__ */ new Set(), d = /* @__PURE__ */ new Set(), m = rn(E(e?.node_runs));
  m.forEach((_) => {
...
function Ii(e, t) {
  return e === Se && String(t || "") === "human_approval" ? "等待人工确认" : lr(e);
}
function rn(e) {
  return [...e].sort(Pi);
}
...
function it(e) {
  return jt(e)?.getTime() ?? Number.MAX_SAFE_INTEGER;
}
function Je(e) {
  return qe(e) === ce;
}
...
function mr(e, t) {
  const n = Nt(String(e?.node_type || "")) ? St(e, t) : void 0;
...
function Bi(e) {
  ...
  const r = Object.entries(de(t.merged)).map(([o, s]) => pr(o, o, s)).filter(G);
...
function An(e, t) {
  [
    ...
    Lt(t[r]) && (e[r] = t[r]);
  }), !Lt(e.rich) && A(t.value) && (e.rich = t.value);
}
function Lt(e) {
...
function Qi(e, t) {
  ...
  if (!n)
    return "等待开始";
  const o = [`开始 ${Cn(n)}`];
  return r ? (o.push(`结束 ${Cn(r)}`), o.push(
...
const hr = ht.cn, ts = Gn.AgentInteractionPanel, ns = J.Dialog, rs = J.DialogContent, os = J.DialogDescription, is = J.DialogTitle, ss = Ze.Select, as = Ze.SelectContent, ds = Ze.SelectItem, cs = Ze.SelectTrigger, ls = Ze.SelectValue, us = ye.formatStreamDuration, fs = ye.useStreamClock, ms = 220, Tn = 170, gs = 150;
function _s({
  view: e,
  flows: t,
  flowEdges: n,
...
function ps({
  ...
  const [N, O] = I(null), Q = Ot(null), Ie = Ot(e), Pe = Ot(!1), { fitView: Ke, screenToFlowPosition: Oe } = no(), ie = fs(!!u?.active), ue = e === "flow" ? t : r, U = e === "flow" ? n : o, W = Te(
    () => ue.map((y) => Gt(e, y)).join("|"),
    [ue, e]
  ), se = Te(
    () => ue.map((y, w) => {
      const S = Gt(e, y), M = vt(w);
      return {
        id: S,
        type: "teamGraphNode",
        position: {
  ...
  ), [te, $e] = I(se), [ee, ze] = I(null), [Be, Qe] = I(""), Dt = Te(() => {
    const y = U.map((w, S) => {
      const M = e === "flow" ? "flow_edge" : "node_edge", V = a?.kind === M && a.index === S, ae = fr(w, S), le = u?.activeEdgeKeys.has(ae), Ue = u?.completedEdgeKeys.has(ae), ge = Os(w, Be), rt = le || Ue, Rt = V ? "#2563eb" : ge || rt ? "#6366f1" : "#d4d4d8";
      return {
        id: Ls(e, w, S),
        source: w.from_key,
        target: w.to_key,
  ...
  Xe(() => {
    ...
    $e((y) => Pe.current ? y : Ie.current !== e ? (Ie.current = e, se) : In(y, se));
  }, [se, e]), Xe(() => {
    if (!N)
      return;
    const y = () => O(null), w = (S) => {
    ...
    const y = (w) => {
      d || !a || w.defaultPrevented || w.key !== "Delete" && w.key !== "Backspace" || xr(w.target) || (w.preventDefault(), P(a));
    };
  ...
  const At = K(
    ...
    (y, w) => {
      y.stopPropagation();
      const S = $n(w), M = a?.kind === S.kind && a.index === S.index, V = Ms(w);
      if (M && !d && !V) {
        P(S);
        return;
      }
...
function bs({ data: e, selected: t }) {
  const n = Gt(e.kind, e.item), r = qt(e.kind, n), o = On(e.item), s = e.executionState?.nodeRunsByKey[n], a = s?.run, c = a?.agent_run_id ? e.executionState?.agentRunsByID[String(a.agent_run_id)] : void 0, d = e.kind === "node" && a && Nt(
    String(a.node_type || On(e.item) || "")
  ) ? St(a, c, {
    node: e.item,
          ...
          e.readonly ? null : /* @__PURE__ */ p("div", { className: "team-graph-actions", children: [
            /* @__PURE__ */ i(
              "button",
              {
                ...
                children: /* @__PURE__ */ i(ut, { size: 13, style: hn })
              }
            ),
            /* @__PURE__ */ i(
              "button",
              {
                ...
                onMouseDown: (k) => k.stopPropagation(),
                children: /* @__PURE__ */ i(jn, { size: 13, style: hn })
              }
            )
          ] })
        ] })
...
function ys(e) {
  return e === ce ? "running" : e === Se ? "waiting" : e === Ne ? "done" : e === wt ? "error" : "idle";
}
function hs(e) {
  if (e == null || e === "")
    return null;
...
function Ss(e, t, n) {
  ...
  return n === "flow" ? /* @__PURE__ */ i(dt, { size: 20, color: "#6366f1" }) : r === "agent" ? /* @__PURE__ */ i(mo, { size: 20, color: "#3b82f6" }) : r === "role" ? /* @__PURE__ */ i(Eo, { size: 20, color: "#6366f1" }) : r === "power" ? /* @__PURE__ */ i(po, { size: 20, color: "#f59e0b" }) : r === "team" ? /* @__PURE__ */ i(dt, { size: 20, color: "#14b8a6" }) : r === "context" ? /* @__PURE__ */ i(go, { size: 20, color: "#0ea5e9" }) : r === "knowledge" ? /* @__PURE__ */ i(fo, { size: 20, color: "#22c55e" }) : r === "condition" ? /* @__PURE__ */ i(_o, { size: 20, color: "#f97316" }) : r === "merge" ? /* @__PURE__ */ i(No, { size: 20, color: "#f43f5e" }) : r === "human_approval" ? /* @__PURE__ */ i(_n, { size: 20, color: "#8b5cf6" }) : r === "save" ? /* @__PURE__ */ i(bn, { size: 20, color: "#10b981" }) : o.includes("收集") || o.includes("输入") || o.includes("反馈") || o.includes("审批") ? /* @__PURE__ */ i(_n, { size: 20, color: "#8b5cf6" }) : o.includes("保存") || o.includes("存储") || o.includes("入库") ? /* @__PURE__ */ i(bn, { size: 20, color: "#10b981" }) : o.includes("写") || o.includes("剧本") || o.includes("故事") || o.includes("设计") || o.includes("创作") ? /* @__PURE__ */ i(so, { size: 20, color: "#a855f7" }) : o.includes("背景") || o.includes("世界") || o.includes("元素") || o.includes("灵感") ? /* @__PURE__ */ i(uo, { size: 20, color: "#f59e0b" }) : /* @__PURE__ */ i(Co, { size: 20, color: "#71717a" });
}
function Ds(e) {
  ...
  if (!t)
    return /* @__PURE__ */ i($t, { path: s, style: r });
  if (t.preview)
    return /* @__PURE__ */ i($t, { path: s, style: r, interactionWidth: 0 });
  const d = wr(t.view, t.index), m = t.view === "flow" ? [] : Yn(
    t.edge,
    t.nodes,
    t.edgeConditions
  ...
  return /* @__PURE__ */ p(Wt, { children: [
    /* @__PURE__ */ i($t, { path: s, style: k, interactionWidth: 32 }),
...
const Ks = ht.cn, Hs = Xt.Button, vr = J.Dialog, Nr = J.DialogContent, Sr = J.DialogDescription, Dr = J.DialogHeader, Ar = J.DialogTitle, Us = qn.Textarea, Cr = Gn.AgentInteractionPanel, Tr = yo.EnergonContentView, Ws = ye.isStreamTimingRunning, Er = ye.StreamTimingBadge, Rr = ye.useStreamClock;
function Ys({
  open: e,
  target: t,
  prompt: n,
  ...
  const g = t === "team" ? "调试" : "调试工作流", f = String(o?.run?.status || o?.status || ""), _ = f ? `当前状态：${lr(f)}` : "调试会先自动保存，并使用当前保存内容运行", h = "输入目标后会先自动保存当前编辑内容，并使用保存后的内容执行；每个节点的执行状态和输出会显示在这里。", k = t === "team" ? "会先保存当前团队工作流编排，再按保存后的内容逐个执行。" : "会先保存当前工作流节点流程，再按节点顺序执行。";
    ...
    Nr,
    {
      ...
      children: [
        /* @__PURE__ */ p(Dr, { children: [
          ...
          /* @__PURE__ */ i(Sr, { className: "sr-only", children: k })
        ] }),
...
function Xs({
  ...
  const o = e?.run || {}, s = rn(E(e?.node_runs)), a = sn(E(e?.agent_runs)), c = Je(o.status) || s.some(
...
function Vs({
  ...
  const c = e.node_name || e.node_key || `节点 ${t + 1}`, d = String(e.node_type || ""), m = _r(e, n), u = Nt(d) ? St(e, n) : void 0, g = mr(e, n), f = d === "save" ? yr(e.output) : "", _ = ur(e);
  return /* @__PURE__ */ p("article", { className: "rounded-md border bg-background p-3", children: [
    /* @__PURE__ */ p("div", { className: "flex flex-wrap items-start justify-between gap-3", children: [
      ...
      u ? /* @__PURE__ */ i(Er, { timing: u, now: s, className: "max-w-full" }) : /* @__PURE__ */ i(Ir, { status: e.status, nodeType: d }),
    ...
    /* @__PURE__ */ i("div", { className: "mt-3 rounded-md border bg-muted/15 p-3", children: G(m) ? /* @__PURE__ */ i(Tr, { output: m, emptyText: "暂无节点输出。" }) : g ? /* @__PURE__ */ p("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ i(Ee, { className: "size-3 animate-spin" }),
      "正在等待节点输出..."
...
function Zs({
  ...
  const d = n.find((C) => C.node_key === t), m = rn(E(r?.node_runs)), u = m.find(
    (C) => String(C?.node_key || "") === t
  ), g = sn(E(r?.agent_runs)), f = u?.agent_run_id ? g[String(u.agent_run_id)] : void 0, _ = String(u?.node_type || d?.type || ""), h = u && !o ? _r(u, f) : void 0, k = _ === "save" && u ? yr(u.output) : "", x = u && Nt(_) ? St(u, f, { node: d, nodeRuns: m }) : void 0, P = Ws(x) || !!(u && Je(u.status)), D = Rr(P), v = ur(u);
    ...
    Nr,
    {
      ...
      children: [
        /* @__PURE__ */ p(Dr, { className: "shrink-0 border-b px-6 py-4", children: [
          /* @__PURE__ */ i(Ar, { className: "min-w-0 truncate pr-7", children: d?.name || u?.node_name || t || "节点结果" }),
        ...
        /* @__PURE__ */ p("div", { className: "min-h-0 min-w-0 flex-1 overflow-y-auto bg-background px-6 py-4", children: [
          x || u ? /* @__PURE__ */ p("div", { className: "mb-3 flex flex-wrap items-center gap-2 rounded-md border bg-muted/15 px-3 py-2", children: [
            ...
            ) : /* @__PURE__ */ i(Ir, { status: u?.status, nodeType: _ })
          ] }) : null,
...
function ta(e, t, n) {
  const r = {}, o = zn(t, "form.name"), s = zn(t, "form.goal");
...
const na = ht.cn, ra = Xt.Button, oa = Kt.AssistantContextFormFillButton, ia = J.Dialog, sa = J.DialogClose, aa = J.DialogContent, da = J.DialogHeader, ca = J.DialogTitle, yt = ho.Input, Ht = qn.Textarea, la = bt.RadioGroup, ua = bt.RadioGroupItem, oe = ko.SearchableOptionPicker;
function fa({
  open: e,
  onOpenChange: t,
  selected: n,
...
function ma({
  ...
  const d = Number(e.role_id || e.config?.role_id || 0), m = s.length ? s : Zt({
    currentTeamID: r,
    currentTeamName: o,
    flows: [],
    roles: t,
...
function ba({
  ...
  const r = Jt(e.config?.operator), o = r === "contains" || r === "equals", s = (a) => n(e.node_key, {
    config: {
      ...e.config ?? {},
      ...a
    }
...
function ya({
  ...
  const s = Number(e.config?.knowledge_base_id || 0), a = Bn(n, s), c = t.length ? t : Ta(n), d = Number(
    a?.cate_id || e.config?.knowledge_cate_id || c[0]?.id || n[0]?.cate_id || 0
  ), m = d ? n.filter(
    (f) => Number(f.cate_id || 0) === d
  ) : n, u = Fn(a), g = (f) => o(e.node_key, {
    config: {
      ...z(e.config, ["goal"]),
      ...f
    }
    ...
    /* @__PURE__ */ i(X, { label: "知识库", children: /* @__PURE__ */ p("div", { className: "grid gap-2 sm:grid-cols-2", children: [
      ...
      /* @__PURE__ */ i(
        oe,
        {
          ...
          onChange: (f) => {
            const _ = Array.isArray(f) ? f[0] ?? "" : f, h = Number(_ || 0), k = Bn(n, h);
            o(
              e.node_key,
              j(
                e,
...
function ha({
  ...
  return /* @__PURE__ */ i(X, { label: "资产类型", children: /* @__PURE__ */ i(
    oe,
    {
      ...
      onChange: (a) => {
        const c = Array.isArray(a) ? a[0] ?? "" : a, d = Number(c || 0), m = Ut(t, d);
        r(
          e.node_key,
          j(
            e,
...
function ka({
  ...
  const a = Qt(n), c = a.find((g) => g.id === e), d = r.length ? Vn(r) : zo(a), m = String(
    c?.cate_id || t || d[0]?.id || ""
  ), u = m ? a.filter(
...
const Ce = Mn.request, zt = ht.cn, we = Xt.Button, Ln = Yr.ConfirmDialog, Oa = Xr.AssistantTaskPopover;
function _d({ item: e }) {
  const t = e.meta ?? {}, n = Te(() => $a(), []), [r, o] = I({}), [s, a] = I(!1), [c, d] = I(!1), [m, u] = I("flow"), [g, f] = I(""), [_, h] = I(null), [k, x] = I(null), [P, D] = I(!1), [v, C] = I(null), [B, H] = I(!1), [F, N] = I(""), [O, Q] = I(!1), [Ie, Pe] = I("team"), [Ke, Oe] = I(""), [ie, ue] = I(!1), [U, W] = I(null), [se, te] = I(""), [$e, ee] = I(() => /* @__PURE__ */ new Set()), ze = String(t.workspaceApi || "/bot/admin/team/workspace_data"), Be = String(t.saveFlowApi || "/bot/admin/team/save_flow_graph"), Qe = String(t.saveNodeApi || "/bot/admin/team/save_node_graph"), Dt = String(t.runTeamApi || "/bot/admin/team/run_team"), At = String(t.runFlowApi || "/bot/admin/team/run_flow"), et = String(
    t.runStatusApi || "/bot/admin/team/run_status"
  ), tt = String(t.streamApi || "/bot/admin/team/stream"), Ct = String(t.approvalApi || "/bot/admin/team/submit_approval"), Tt = String(
    t.interactionApi || "/bot/admin/team/submit_interaction"
  ), He = String(t.paramApi || "/bot/admin/energon/power_params"), Et = en(
    r.team?.publish_status
  ), De = Zn(r.team), fe = r.flows ?? [], nt = r.flow_edges ?? [], me = fe.find((l) => l.key === g), he = g ? r.nodes_by_flow?.[g] ?? [] : [], Fe = g ? r.edges_by_flow?.[g] ?? [] : [], y = r.roles ?? [], w = r.agents ?? [], S = r.agent_cates ?? [], M = r.asset_cates ?? [], V = r.knowledge_cates ?? [], ae = r.knowledge_bases ?? [], le = r.teams ?? [], Ue = r.role_types?.length ? r.role_types : Kn, ge = Te(
    () => Zt({
      currentTeamID: n,
  ...
  ), rt = r.powers ?? [], Rt = r.power_kinds ?? [], an = Ko(
    r.node_types?.length ? r.node_types : kt
  ), Or = r.edge_conditions?.length ? r.edge_conditions : Hn, ke = m === "node" && Ie === "flow" && !!(ie || U), L = De || ke, ot = Te(
    () => Ni(U, $e),
    [U, $e]
  ), $r = Te(
    () => ke ? Ei(
  ...
  }, []), _e = K(() => De ? ($.info("团队已发布，请先进入编辑草稿后再修改"), !1) : !0, [De]), dn = K(async () => {
    if (n) {
      a(!0);
      try {
  ...
  const It = async () => {
    ...
    try {
      if (!De && !(l === "flow" ? await cn() : await It())) {
        W(null);
        return;
      }
      if (q?.aborted)
      ...
      children: [
        /* @__PURE__ */ p("aside", { className: "flex min-h-0 min-w-0 flex-col border-r bg-muted/20", children: [
          /* @__PURE__ */ p("div", { className: "border-b p-4", children: [
            ...
            /* @__PURE__ */ i("div", { className: "mt-2 inline-flex rounded bg-background px-2 py-0.5 text-xs text-muted-foreground", children: Go(Et) })
          ] }),
          ...
          /* @__PURE__ */ p("div", { className: "flex items-center justify-between px-3 py-2", children: [
            ...
            /* @__PURE__ */ i(
              we,
              {
                ...
                disabled: L,
                onClick: un,
                children: /* @__PURE__ */ i(gn, { className: "size-4" })
              }
            )
          ] }),
          /* @__PURE__ */ i(
              ...
              children: fe.map((l) => /* @__PURE__ */ p(
                "div",
                {
                  ...
                  className: zt(
                    ...
                    wn(m, g, l) ? "bg-primary text-primary-foreground" : "hover:bg-muted",
                    F === l.key && "opacity-60",
                    ...
                    /* @__PURE__ */ i(
                      "button",
                      {
                        ...
                        className: zt(
                          ...
                          wn(m, g, l) && "hover:bg-primary-foreground/15",
            ...
            children: [
              /* @__PURE__ */ p("div", { className: "flex flex-wrap items-center gap-2 border-b px-4 py-3", children: [
                ...
                De ? /* @__PURE__ */ p(
                  ...
                  we,
                  {
                    ...
                    onClick: () => H(!0),
                    children: [
                      c ? /* @__PURE__ */ i(Ee, { className: "size-4 animate-spin" }) : /* @__PURE__ */ i(Ur, { className: "size-4" }),
                      "发布"
                    ]
                  }
                ),
                ...
                m === "node" && me ? /* @__PURE__ */ i(
                  Oa,
                  {
                    ...
                    onSubmit: async ({
                      ...
                      signal: T,
                      setStatus: q
                    }) => l.trim() ? (q("正在启动工作流调试"), ln("flow", l, b, T), !0) : ($.error("请输入调试要求或目标"), !1)
                  }
                ) : null,
                ke ? /* @__PURE__ */ i(
                  we,
              ...
              /* @__PURE__ */ i(
                _s,
                {
                  ...
                  onEdit: Gr,
                  onDelete: Kr,
                  onFlowConnect: (l, b) => L ? void 0 : o((T) => tr(T, l, b)),
                  ...
                  onMove: (l, b, T) => L ? void 0 : o(
                    (q) => l === "flow" ? xn(q, b, { position: T }) : vn(q, g, b, { position: T })
                  ),
        ...
        /* @__PURE__ */ i(
          fa,
          {
            ...
            nodeTypes: an,
            readonly: L,
            onChangeFlow: (l, b) => L ? void 0 : o((T) => xn(T, l, b)),
