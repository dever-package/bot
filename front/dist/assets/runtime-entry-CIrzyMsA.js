...
const J = {
  ...
  nodes: {
    "show-agent": n(
      () => import("./agent-oPmi7GuN.js").then((e) => ({
        default: e.ShowAgent
      }))
    ),
    "show-agent-chat": n(
      () => import("./agent-chat-APFEM4TJ.js").then((e) => e.a).then((e) => ({
        default: e.ShowAgentChat
      }))
    ),
    "show-skill-creator": n(
      () => import("./skill-creator-BFTlT_eZ.js").then((e) => ({
        default: e.ShowSkillCreator
      }))
    ),
    "show-skill-test": n(
      () => import("./skill-test-CGkU1rox.js").then((e) => ({
        default: e.ShowSkillTest
      }))
    ),
    "show-team-workspace": n(
      () => import("./team-workspace-DI9YNjCK.js").then((e) => ({
        default: e.ShowTeamWorkspace
      }))
    ),
    "show-stream-request": n(
      () => import("./stream-request-kfEbcJvU.js").then((e) => e.s).then((e) => ({
        default: e.ShowStreamRequest
      }))
    ),
    "show-knowledge-file-manager": n(
      () => import("./knowledge-file-manager-bvEhuYRq.js").then((e) => ({
        default: e.ShowKnowledgeFileManager
      }))
    ),
    "bot-body-work-login-page": n(
      () => import("./login-page-DiLjiA83.js").then((e) => ({
        default: e.WorkLoginPage
      }))
    ),
    "bot-body-content-page": n(
      () => import("./standalone-content-page-FaqKwnQN.js").then(
        (e) => ({
    ...
    "bot-body-work-home-shell": n(
      () => import("./home-shell-DNmuRlvV.js").then((e) => e.h).then((e) => ({
    ...
    "bot-body-work-space-page": n(
      () => import("./space-entry-DO3nFNaO.js").then((e) => e.s).then((e) => ({
