import { c as so, j as d, a as F, F as xe } from "./createLucideIcon-fWv1XcFy.js";
import { R as Ve, J as le, h as no, G as pn, d as L, f as ae, M as ps, N as mt, O as et, H as ro, c as ie, b as X, e as ee, i as ht, g as oo } from "./runtime-entry-ClkZDmNs.js";
import { c as io, u as nt } from "./content-view-BXwDWBA5.js";
import { A as ao } from "./arrow-left-8fGzp-c8.js";
import { P as fn } from "./_commonjsHelpers-BNFp87fY.js";
import { X as co } from "./in-flight-request-CXY2yBH9.js";
import { m as lo } from "./store-Qy-gDmQw.js";
import { m as gn, a as jt } from "./stream-B1l_qwg7.js";
import { m as bt } from "./utils-CHRiz5MX.js";
import { m as Gt } from "./button-D8VCR9tT.js";
import { m as fe } from "./dialog-Bzy9HxZl.js";
import { r as te, f as y, u as pe, g as de, C as uo, h as Q, i as ve, j as M, k as Ue, n as mo, l as vn, w as ye, m as ho, o as bn, p as xn, q as po, s as Wt, v as ze, x as Yt, D as be, y as _e, z as fo, B as fs, E as Fe, T as Se, F as go, G as yn, H as Qt, I as vo, J as pt, K as bo, L as xo, M as yo, N as _n, O as _o, P as wo, Q as Dt, R as wn, S as To, U as Io, V as So, W as gs, X as Co, Y as Ro, Z as Eo, _ as Mo, $ as Ao, a0 as Po, a1 as Tn, a2 as Jt, a3 as Zt, a4 as ko, a5 as Do, a6 as It, a7 as ft, t as In, a8 as $o, a9 as No, aa as Oo, ab as Bo, ac as Lo, ad as Ye, ae as vs, af as Vo, ag as Fo, ah as qo, ai as Uo, aj as bs, c as zo, ak as Ho, A as jo, a as Go, al as Wo, am as Yo, d as Qo, an as Jo, e as Zo, ao as Xo, ap as Ko } from "./interaction-view-vfqHePvj.js";
import { L as ut } from "./vanilla-BSPxkY5-.js";
import { w as ei, c as ti } from "./site-config-DrnclGFw.js";
import { E as si } from "./ellipsis-DUwJfgBr.js";
import { P as ni } from "./pencil-DsS_UhAq.js";
import { T as ri } from "./trash-2-C2PWG3er.js";
import { m as oi } from "./input-CpVa-RSd.js";
import { A as Sn, a as dt, c as ii, b as ai, d as ci } from "./clipboard-CS1yff3P.js";
import { m as xt } from "./runtime-stream-runner-DadR9qgq.js";
import { d as Cn, n as li, s as ui, t as di, g as yt, f as mi, h as Rn, m as hi, u as pi, v as xs, e as fi, w as gi, k as gt, i as En, C as vi, a as bi, c as xi, x as yi, r as _i, y as wi, q as Ti } from "./interaction-Cyugb7TD.js";
import { A as Ii } from "./arrow-down-BEwslZTQ.js";
import { B as Si } from "./bot-JFFKszUF.js";
import { C as Ci } from "./check-B_RB4H2g.js";
import { C as Ri } from "./copy-BlmHyHAH.js";
import { C as Ei } from "./chevron-down-e5qsfp_F.js";
const Mi = [
  [
    "path",
    {
...
function _t(t) {
  const e = y(3), { getItemState: s, children: n } = t, r = Fi(s);
  let o;
...
function ji(t) {
  const e = Ve.useRef(ys);
  return Ve.useInsertionEffect(() => {
    e.current = t;
  }, [t]), (...s) => {
    Hi() && ys();
    const n = e.current;
...
const An = (t) => {
  ...
  e[9] !== m || e[10] !== s ? (g = () => {
    ...
    for (const [R, v] of Object.entries(s)) {
      const b = "render" in v ? v.render : void 0, I = "renderText" in v ? v.renderText : void 0, _ = b ?? (I ? Vi(I) : void 0);
...
const Na = (t) => t._core?.RenderComponent, Oa = le(({ runtime: t, aui: e = null, children: s }) => {
  "use no memo";
  const n = Q({ threads: $a(t) }, { parent: e }), r = Na(t), o = /* @__PURE__ */ F(_e, {
    value: n,
...
}, Fa = class extends TransformStream {
  constructor(t) {
    super({ transform(e, s) {
      s.enqueue({
        ...e,
...
var Ha = class Ln {
  ...
  _addPart(e, s) {
    this._state.append && (this._state.append.controller.close(), this._state.append = void 0), this.enqueue({
      ...
      part: e,
      path: []
    }), this._state.merger.addStream(s.pipeThrough(new Fa(this._state.contentCounter.value)));
  }
  merge(e) {
  ...
  addToolCallPart(e) {
    const s = typeof e == "string" ? { toolName: e } : e, n = s.toolName, r = s.toolCallId ?? za(), [o, i] = Va();
...
var Qa = class {
  ...
  update(t) {
    if (!this.disposed)
      try {
        if (Fe(t, this.fieldPath) === "complete") {
  ...
  update(t) {
    if (!this.disposed)
      try {
        const e = qe(t, this.fieldPath);
        e !== void 0 && this.controller.enqueue(e), Fe(t, this.fieldPath) === "complete" && (this.controller.close(), this.dispose());
      } catch (e) {
  ...
  update(t) {
    if (!this.disposed)
      try {
        ...
        Fe(t, this.fieldPath) === "complete" && (this.controller.close(), this.dispose());
      } catch (e) {
        this.controller.error(e), this.dispose();
      }
  }
  ...
  update(t) {
    if (!this.disposed)
      try {
        ...
        for (let s = 0; s < e.length; s++) this.processedIndexes.has(s) || Fe(t, [...this.fieldPath, s]) === "complete" && (this.controller.enqueue(e[s]), this.processedIndexes.add(s));
        Fe(t, this.fieldPath) === "complete" && (this.controller.close(), this.dispose());
      } catch (e) {
        this.controller.error(e), this.dispose();
      }
  ...
  get(...t) {
    return new Promise((e, s) => {
      ...
      if (this.args && Fe(this.args, t) === "complete") {
...
const Ps = ({ children: t }) => {
  ...
  return Ue(() => e === 0 ? null : Array.from({ length: e }, (s, n) => /* @__PURE__ */ d(Fn, {
    index: n,
...
const Vc = (t) => typeof t == "object" && t !== null, Gn = (t, e, s, n) => {
  if (t == null) return null;
  if (typeof t == "string") return t;
  if (!Vc(t) || !("component" in t) || typeof t.component != "string")
    return null;
  ...
  let o;
  e[0] !== s ? (o = Fc(s), e[0] = s, e[1] = o) : o = e[1];
  const i = o;
  let a;
...
const ll = (t) => {
  ...
  let p;
  return e[11] !== l || e[12] !== u || e[13] !== m ? (p = /* @__PURE__ */ F(xe, { children: [
    u,
    l,
    m
...
const Il = /* @__PURE__ */ Symbol.for("@assistant-ui/groupBy.memoKey"), Ns = (t) => {
  ...
  return /* @__PURE__ */ F(xe, { children: [Ue(() => {
    const i = { toolUIs: r };
...
const Bs = ({ children: t }) => {
  ...
  return Ue(() => Array.from({ length: e }, (s, n) => /* @__PURE__ */ d(Vn, {
    index: n,
    children: /* @__PURE__ */ d(_t, {
...
const lr = Qt(null), { useThreadViewport: ke, useThreadViewportStore: De } = Po(nu(lr, "ThreadPrimitive.Viewport"), "useThreadViewport"), Vs = (t) => {
  ...
  const e = /* @__PURE__ */ new Set(), s = Vs((i) => {
    o.setState({ height: {
      ...o.getState().height,
      viewport: i
    } });
  ...
  let c;
  return e[3] !== r || e[4] !== o || e[5] !== a ? (c = /* @__PURE__ */ F(Oa, {
    runtime: r,
    aui: o,
    children: [i, a]
...
He(Vt, "getOwnerDocument");
function xr(t, e = !1) {
  const { activeElement: s } = Vt(t);
  if (!s?.nodeName)
    return null;
...
const Oe = (t) => {
  ...
  return e[0] !== s || e[1] !== n ? (r = (o) => {
    ...
    return i.registerAnchorTargetElement(o, {
      tallerThan: Fs(a.tallerThan, o),
      visibleHeight: Fs(a.visibleHeight, o)
    });
...
Ft.displayName = "MessagePrimitive.Parts";
const Pr = (t) => {
  const { children: e } = t;
...
}, Fd = (t) => Lr(t)?.anchorId, qd = (t) => Lr(t)?.targetId, Ud = () => Or(ke(jd), Gd), zd = () => Oe(ke(Wd)), Hd = (t) => {
  const e = y(13), s = De();
  let n;
  e[0] !== t ? (n = (h) => {
    if (t)
...
Vr.displayName = "ThreadPrimitive.ViewportScrollable";
const Fr = ae((t, e) => {
  const s = y(13);
  let n, r, o;
...
Fr.displayName = "ThreadPrimitive.Viewport";
function jd(t) {
...
const Je = Gt.Button, Hs = fe.Dialog, js = fe.DialogContent, Gs = fe.DialogDescription, Ws = fe.DialogFooter, Ys = fe.DialogHeader, Qs = fe.DialogTitle, nm = oi.Input, rm = bt.cn, Ut = 152, Js = 76, Zs = 6, Ze = 8;
function om({
  session: t,
  active: e,
  controller: s
        ...
        children: [
          /* @__PURE__ */ F(
            "button",
            {
              ...
              onClick: b,
              children: [
                /* @__PURE__ */ d(ni, { className: "size-4 shrink-0" }),
                "编辑标题"
              ]
            }
          ),
          /* @__PURE__ */ F(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ d(ri, { className: "size-4 shrink-0" }),
                "删除"
              ]
            }
          )
  ...
  return /* @__PURE__ */ F(xe, { children: [
    /* @__PURE__ */ d("span", { ref: R, className: "flex shrink-0", children: /* @__PURE__ */ d(Sn, { label: "会话操作", children: /* @__PURE__ */ d(
      Je,
      {
        type: "button",
        variant: "ghost",
        ...
        "aria-expanded": w,
        onClick: T,
        children: /* @__PURE__ */ d(si, { className: "size-4" })
      }
    ) }) }),
    $,
    /* @__PURE__ */ d(
        ...
        children: /* @__PURE__ */ F(
          js,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ F("form", { className: "space-y-4", onSubmit: I, children: [
                /* @__PURE__ */ d(
                  nm,
                  {
                    autoFocus: !0,
...
function en({
  ...
  return /* @__PURE__ */ F(
    "aside",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "agent-chat-sidebar-header shrink-0 border-b p-3", children: /* @__PURE__ */ F("div", { className: "agent-chat-sidebar-controls flex min-w-0 items-center gap-2", children: [
          ...
          /* @__PURE__ */ F(
            cm,
            {
              ...
              children: [
                /* @__PURE__ */ d("span", { className: "agent-chat-new-session-icon contents", children: /* @__PURE__ */ d(fn, { className: "size-4" }) }),
        ...
        /* @__PURE__ */ F("div", { className: "agent-chat-session-section flex min-h-0 flex-1 flex-col", children: [
          ...
          /* @__PURE__ */ d(
            "div",
            {
              ...
              children: n.sessionsLoading && n.sessions.length === 0 ? /* @__PURE__ */ d("div", { className: "flex h-24 items-center justify-center text-muted-foreground", children: /* @__PURE__ */ d(ut, { className: "size-4 animate-spin" }) }) : n.sessions.length === 0 ? /* @__PURE__ */ d("div", { className: "px-2 py-6 text-center text-xs leading-5 text-muted-foreground", children: "暂无历史会话" }) : /* @__PURE__ */ F("div", { className: "space-y-1", children: [
...
const dm = xt.runRuntimeStream, mm = xt.stopRuntimeStream, hm = xt.watchRuntimeStream, Et = jt.runtimeErrorMessage, sn = gn.streamValueText;
function pm({
  agentKey: t,
  contextKey: e,
  modalOpen: s,
  ...
  const [C, D] = X({}), R = ee(/* @__PURE__ */ new Map()), v = L(
    ...
    (f, E) => {
      R.current.get(f.sessionID) === f && (f.buffer.flush(), _(f, (A) => {
        ...
        return di(E.output) && (j.output = E.output), j.document = yt(
          A.document,
          q
...
const bm = xt.watchRuntimeStream, xm = jt.normalizeRuntimeFrameOutput;
function ym({
  modalOpen: t,
  sessionID: e,
  messages: s,
  ...
  ie(() => {
    ...
    for (const u of s)
      u.document && (c.set(u.document.id, u.document), gi(u.document) && l.set(u.document.id, u.document));
    for (const [u, m] of a) {
      const p = c.get(u);
      if (!p || m.sessionID !== e) {
  ...
  const u = (h) => {
    ...
    a = h, c = Date.now(), e.controller.signal.addEventListener("abort", g, { once: !0 }), bm({
      ...
      onFrame: (w) => {
        c = Date.now();
        const x = Im(w);
        u(Rn(e.document, x)), Sm(x) === "document_complete" && m().catch(() => {
        });
      }
    }).catch(() => {
    }).finally(() => {
...
function Em(t) {
  return t.filter((e) => !e.document).flatMap(
    (e) => En(e.output).filter((s) => s.status === "generating").map((s) => s.id)
  ).sort((e, s) => e - s).join(":");
}
function Mm(t, e) {
  return new Promise((s) => {
...
function Dm({
  ...
  const l = e?.trim() || (t ? `agent-runtime:${t}` : ""), [u, m] = X([]), [p, h] = X(0), [g, w] = X("新会话"), [x, C] = X([]), [D, R] = X(!1), [v, b] = X(!1), [I, _] = X(!1), [T, $] = X(""), [k, z] = X([]), B = ee(0), U = ee(/* @__PURE__ */ new Map()), W = ee(
    ...
    (S) => {
      ...
      const P = `${N}:${S.refType}:${S.refId}`, V = W.current.get(P);
      if (V)
        return V;
      const H = Lo(
        a.referencePreview,
  ...
  const Be = L(
    (S, N = !1) => {
      ...
      if (!P)
        return;
      const V = Z.mergeMessages(
        P,
        Mt(S.messages)
      ), H = U.current.get(P), ue = H ? an(H.messages, V) : V, he = {
    ...
    try {
      ...
      const V = P.sessions[0], H = V ? U.current.get(V.id) : void 0;
      if (V && H && (q(V.id, H), _(!1)), !V && r && !o) {
      ...
      Y.current === S && (Be(ue, !V), !V && o && ue.session?.id && Z.startOpening(ue.session.id));
    } catch (P) {
    ...
    async (S, N = !1) => {
      ...
      const P = ++Y.current;
      f.current = !1;
      const V = N ? void 0 : U.current.get(S);
      V ? (q(S, V), _(!1)) : (N && (B.current = 0, h(0), w("新会话"), C([])), _(!0)), $("");
      try {
        const H = await Ye(i, {
          agentKey: t,
          contextKey: l,
    ...
    async (S) => {
      ...
      try {
        if (await Fo(i, S), U.current.delete(S), m(P), $(""), B.current !== S)
          return;
        const V = Math.min(
          Math.max(0, N),
    ...
    try {
      ...
      const V = P.sessions[P.sessions.length - 1]?.id || 0;
      m(
        (H) => Am(
          H,
          P.sessions.map((ue) => ({
      ...
      ), G.current = V, re.current = P.hasMore && V > 0 && V !== N;
    } catch (P) {
    ...
    if (!S || !N?.canLoadOlder || !N.oldestMessageID || !t || !l || f.current)
      return;
    const P = O.current, V = P?.scrollHeight || 0, H = P?.scrollTop || 0, ue = Y.current;
    f.current = !0;
    try {
      const he = await Ye(i, {
        agentKey: t,
      ...
      j(S, {
        ...
        window.requestAnimationFrame(() => {
          const Te = O.current;
          !Te || B.current !== S || (Te.scrollTop = H + Te.scrollHeight - V, E.current = Te.scrollTop);
        });
      });
    } catch (he) {
...
function Nm({
  ...
  ie(() => {
    ...
    i((w) => g < 0 ? Ht(w, h.length) : Vm(g, h.length));
  }, [n, s]), ie(() => {
    a.current && n && Fm(a.current, n);
  }, [n, s]);
  const c = L(
    (h) => {
...
function Hm({
  ...
  return /* @__PURE__ */ F(Qe.Root, { className: "agent-chat-thread relative flex min-h-0 flex-1 flex-col bg-background", children: [
    /* @__PURE__ */ d("style", { children: Xm }),
    /* @__PURE__ */ F(Qe.ViewportProvider, { children: [
      /* @__PURE__ */ d(
        Qe.Viewport,
        {
          ...
          children: /* @__PURE__ */ d(
            "div",
            {
              ...
              children: t.sessionLoading && t.messages.length === 0 ? /* @__PURE__ */ d("div", { className: "agent-chat-empty-state text-muted-foreground", children: /* @__PURE__ */ d(ut, { className: "size-5 animate-spin" }) }) : t.messages.length === 0 ? /* @__PURE__ */ F("div", { className: "agent-chat-empty-state", children: [
                /* @__PURE__ */ d("span", { className: "flex size-10 items-center justify-center rounded-md border bg-muted/30 text-muted-foreground", children: /* @__PURE__ */ d(Si, { className: "size-5" }) }),
      ...
      /* @__PURE__ */ F(
        "footer",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ F("div", { className: dn, children: [
...
function Gm({
  ...
  return /* @__PURE__ */ F(qt.Root, { className: "agent-chat-message agent-chat-user-message relative flex flex-col items-end pl-6 md:pl-20", children: [
...
function Wm({
  ...
  ), p = Array.isArray(a) ? a : [], h = xi(i), g = h?.id ? yi(t.messages, h.id) : void 0, w = _i(i), x = wi(i), C = o?.type === "incomplete" && o.reason === "error", D = !!(l && o?.type === "running" && !gt(l) && !x), R = Zm(
    o?.type === "running",
    p,
    c
  );
    ...
    qt.Root,
    {
      ...
      children: /* @__PURE__ */ F(
        Uo,
        {
          ...
          render: n,
          children: [
            l ? /* @__PURE__ */ F(xe, { children: [
              u ? /* @__PURE__ */ d(bs, { text: u, error: C }) : null,
              /* @__PURE__ */ d(
                zo,
                {
                  document: l,
              ...
              /* @__PURE__ */ d(qt.Parts, { children: ({ part: v }) => {
                if (v.type === "text")
                  return v.status.type === "running" && !v.text && p.length === 0 ? /* @__PURE__ */ d(Jm, {}) : v.text ? /* @__PURE__ */ d(Ho, { error: C }) : null;
                if (v.type === "tool-call") {
                  const b = p.find(
                    (I) => I.id === v.toolCallId
                  );
                  return /* @__PURE__ */ d(jo, { activity: b });
                }
                return null;
              } }),
...
`)
  ), m = c?.hydrated ? Ti(c) : typeof a == "string" && a.trim() ? a : u, [p, h] = X(!1), [g, w] = X(!1), x = ee(null);
  ie(
    () => () => {
  ...
  }, R = !m.trim() || t === "assistant" && n?.type === "running", v = En(l).some(
          ...
          Sn,
          {
            ...
            children: /* @__PURE__ */ F(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ d(Ri, { className: "agent-chat-copy-icon", "aria-hidden": "true" }),
                  /* @__PURE__ */ d(Ci, { className: "agent-chat-copied-icon", "aria-hidden": "true" })
                ]
              }
            )
          }
...
`, lt = lo.getStoreValueByPath, Pt = gn.streamValueText, hn = bt.cn, kt = Gt.Button, Km = fe.Dialog, eh = fe.DialogContent, th = fe.DialogDescription, sh = fe.DialogHeader, nh = fe.DialogTitle;
...
function oh({
  ...
  const k = Dm({
    ...
    runtimeApi: R,
    requestScope: v
  }), z = Jo(), B = z.open && z.request?.kind !== "audio" && z.request?.kind !== "file", [U, W] = X("chat"), J = ee(null), [Y, se] = X(0), [G, re] = X(!1), K = ee(/* @__PURE__ */ new Set()), f = ht(
    () => k.messages.find(
      (ne) => ne.document?.id === Y
    ),
    [Y, k.messages]
  ...
  if (!n)
    return null;
  const oe = /* @__PURE__ */ d(Ko, { controller: z, children: /* @__PURE__ */ F(
    "div",
    {
      ref: J,
              ...
              /* @__PURE__ */ F("header", { className: "agent-chat-header flex h-12 shrink-0 items-center gap-2 px-3 md:h-14 md:px-6", children: [
                ...
                /* @__PURE__ */ F(
                  kt,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ d(fn, { className: "size-4" }),
    ...
    Km,
    {
      ...
      children: /* @__PURE__ */ F(
        eh,
        {
          ...
          children: [
            /* @__PURE__ */ F(sh, { className: "sr-only", children: [
