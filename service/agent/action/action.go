...
func mergeTopLevelToolInput(input map[string]any, raw map[string]any) map[string]any {
	...
	for _, key := range []string{
		...
		"script", "path", "paths", "storage_path", "storage_paths", "storagePath", "storagePaths", "file", "file_name", "file_names", "dir", "directory", "args", "arguments",
		"route", "api", "server", "timeout_seconds", "timeoutSeconds",
		"max_images", "maxImages", "rule_id", "ruleId", "name", "file_id", "file_ids", "fileId", "fileIds", "filename", "filenames", "fileName", "fileNames", "mime", "mime_type", "mimeType",
